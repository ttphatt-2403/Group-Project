...
namespace BackendApi.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        // GET: api/Book/search?query=...&pageNumber=1&pageSize=10
        [NonAction]
        public async Task<ActionResult<object>> SearchBooksPaged(string query = "", int pageNumber = 1, int pageSize = 10)
        {
            if (pageNumber < 1) pageNumber = 1;
            if (pageSize < 1) pageSize = 10;
