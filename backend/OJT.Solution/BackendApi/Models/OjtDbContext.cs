...
public partial class OjtDbContext : DbContext
{
    ...
    {
        // Configuration is provided by the application's DI in Program.cs.
        // Avoid hardcoding the connection string here to prevent leaking secrets and to silence the scaffold warning.
        // If options are not configured, do nothing so the DI registration controls configuration.
